...
const ContactScreen = () => {
  ...
  return (
    <section className="py-20 bg-slate-800 text-white font-poppins">
      <p className="flex justify-center w-full font-semibold md:text-4xl text-3xl my-10">
      ...
      <div className="md:flex md:justify-between text-sm text-black md:gap-16 gap-0 mt-5 p-2">
        ...
        <motion.div
          className="basis-1/2 mt-10 md:mt-0 px-8"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ delay: 0.2, duration: 1 }}
